...
public:
    ...
    long unsigned numof_messa,long unsigned int window_send){
        ...
        window_send_main=this->my_window_send>numof_messa? numof_messa:this->my_window_send;
    ...
    Message deliver(){
        ...
        if(m.seq_n!=0){
            ...
            ******************************************************************/
            //cout<<"Current Num "<<current_num<<endl;
            if(current_num+1>host_num/2 && current_num+1<=host_num/2+1){
                /*******************************************************
                    Control: Important Dynamic Window for Braodcasting in URB.
                ********************************************************/
                ...
                return m;
                // WARN: Not deliver message broadcasted.
                // else{           
                //     return m;
                // }
            }
