...
extern vector<vector<long unsigned>> vec_proposals;
extern vector<set<long unsigned> > Todecide;
extern mutex mut_send;
extern mutex mut_broadcast;
// class BlockingQueue{
// private:
...
//     void pop(){
//         messa_to_onehost.erase(messa_to_onehost.begin());
//     }
